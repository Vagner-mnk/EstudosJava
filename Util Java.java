...
import java.util.*; //Imports all librarys from java.util
...
// final means that this value can't be changed (constant)
...
// Shorthand for numberOfAnimals = numberOfAnimals + 1;
 ...
 public void setUniqueID() {
     ...
     int whichIsBigger = (50 > randomNumber) ? 50 : randomNumber; //Igual função iif
...
//Tratamento de excessão utilizando Try Catch lição 6
...
public static int checkValidAge()
{
	try
	{
		return userInput.nextInt(); //Recebe um número inteiro
	}
	catch(InputMismatchException e)
	{
		userInput.next(); //Limpa o que foi digitado no teclado
